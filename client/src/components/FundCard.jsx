        ...
        <div className='sm:w-[288px] w-full rounded-[15px] bg-[#1c1c24] cursor-pointer' onClick={handleClick}>
            ...
            <div className='flex flex-col p-4'>
                <div className='flex flex-row items-center mb-[18px]'>
                    ...
                    <p className='
                ml-[12px] mt-[2px] font-epilogue font-medium text-[12px] text-[#808191]'>Details</p>
                </div>
                ...
                <div className='block'>
                    ...
                    <p className='mt-[5px] font-epilogue font-normal font-[12px] text-[#808191] text-left leading-[18[x] truncate'>
                        {description}
                    </p>
                </div>
                ...
                <div className='flex items-center mt-[20px] gap-[12px]'>
                    <div className='w-[30px] h-[30px] rounded-full flex justify-center items-center bg-[#13131a]'>
                        <img src={thirdweb} className='h-1/2 w-1/2 object-contain' />
                    </div>
